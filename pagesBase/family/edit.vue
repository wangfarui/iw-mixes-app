<template>
  <view class="edit-page">
    ...
    <view class="btn-group">
      <button class="btn btn-primary" @tap="handleSubmit" :loading="isSubmitting">保存修改</button>
    </view>
  </view>
</template>
...
import { getMyGroup, updateGroup } from '@/api/family.js'
